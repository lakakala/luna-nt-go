...
type ConnectReq struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	SessionId     *uint64                `protobuf:"varint,1,opt,name=session_id,json=sessionId,proto3,oneof" json:"session_id,omitempty"`
...
func (x *ConnectReq) GetSessionId() uint64 {
...
func (x *DataWindowNoti) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DataWindowNoti) ProtoMessage() {}

func (x *DataWindowNoti) ProtoReflect() protoreflect.Message {
	mi := &file_proto_message_proto_msgTypes[6]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DataWindowNoti.ProtoReflect.Descriptor instead.
func (*DataWindowNoti) Descriptor() ([]byte, []int) {
	return file_proto_message_proto_rawDescGZIP(), []int{6}
}

func (x *DataWindowNoti) GetSize() uint32 {
	if x != nil && x.Size != nil {
		return *x.Size
	}
	return 0
...
const file_proto_message_proto_rawDesc = "" +
	...
	"ConnectReq\x12\"\n" +
	"\n" +
	"session_id\x18\x01 \x01(\x04H\x00R\tsessionId\x88\x01\x01\x12\x17\n" +
	...
	"\x05_data\"2\n" +
	"\x0eDataWindowNoti\x12\x17\n" +
	"\x04size\x18\x01 \x01(\rH\x00R\x04size\x88\x01\x01B\a\n" +
	"\x05_sizeB\x06Z\x04./pbb\x06proto3"
...
var file_proto_message_proto_goTypes = []any{
	...
	(*DataWindowNoti)(nil), // 6: DataWindowNoti
}
...
func file_proto_message_proto_init() {
	...
	file_proto_message_proto_msgTypes[5].OneofWrappers = []any{}
